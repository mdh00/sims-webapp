...
<div class="header_navbar">
	...
	<form action="edit" method="post">
		<fieldset>
			...
			<input type="text" name="lesson" value="<%=lesson%>"><br>
			
			<label for="date">Date</label><br>	
			<input type="date" name="date" id="date" value="<%=date%>" oninput="validateDate()" ><br> 
			
			<label for="start-time">Start Time</label><br>
<input type="time" name="start-time" id="start-time" value="<%= (start_time != null && !start_time.isEmpty()) ? start_time : "00:00" %>"><br>

<label for="end-time">End Time</label><br>
<input type="time" name="end-time" id="end-time" value="<%= (end_time != null && !end_time.isEmpty()) ? end_time : "00:00" %>" onblur="validateForm()"><br>

			
			<label for="venue">Venue</label><br>
			<input type="text" name="venue"value="<%=venue%>"><br>
			
			<input type="submit" class="update" value="Update Class" />
		</fieldset>
	</form><br>
 <!-- Footer-->
<footer class="f-con">
